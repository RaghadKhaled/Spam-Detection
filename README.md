...
A small ML Project for detecting and classifying SMS messages as spam or not spam, on a bag of words data using Naive Bayes classification Algorithm. Then expand this analysis by using Ensembles Methods.
