...
bagging_pred = bagging.predict(testing_data)

# Predict using RandomForestClassifier on the test data
randomforest_pred = randomforest.predict(testing_data)

# Predict using AdaBoostClassifier on the test data
adaboost_pred = adaboost.predict(testing_data)
...
print_metrics(y_test,bagging_pred,model_name='bagging')

# Print Random Forest scores
print_metrics(y_test,randomforest_pred,model_name='randomforest')

# Print AdaBoost scores
print_metrics(y_test,adaboost_pred,model_name='adaboost')
